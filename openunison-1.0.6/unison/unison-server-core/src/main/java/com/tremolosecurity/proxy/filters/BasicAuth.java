...
public class BasicAuth implements HttpFilter {
	...
	public void initFilter(HttpFilterConfig config) throws Exception {
		...
		if (config.getAttribute("uidAttr") != null) {
			this.uidAttrName = config.getAttribute("uidAttr").getValues().get(0);
		} else {
			this.uidAttrName = "uid";
		}
