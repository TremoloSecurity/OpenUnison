...
@XmlType(name = "", propOrder = {
    "getRoleCollectionResult"
})
@XmlRootElement(name = "GetRoleCollectionResponse")
public class GetRoleCollectionResponse {

    @XmlElement(name = "GetRoleCollectionResult")
     ...
     * @return
     *     possible object is
     *     {@link GetRoleCollectionResponse.GetRoleCollectionResult }
     *     
     */
    ...
    public void setGetRoleCollectionResult(GetRoleCollectionResponse.GetRoleCollectionResult value) {
        this.getRoleCollectionResult = value;
    }
    ...
    public static class GetRoleCollectionResult {
