...
@XmlType(name = "", propOrder = {
    "getUserCollectionResult"
})
@XmlRootElement(name = "GetUserCollectionResponse")
public class GetUserCollectionResponse {

    @XmlElement(name = "GetUserCollectionResult")
     ...
     * @return
     *     possible object is
     *     {@link GetUserCollectionResponse.GetUserCollectionResult }
     *     
     */
    ...
    public void setGetUserCollectionResult(GetUserCollectionResponse.GetUserCollectionResult value) {
        this.getUserCollectionResult = value;
    }
    ...
    public static class GetUserCollectionResult {
