...
public class CloseHttpConnectionsOnLogout implements LogoutHandler {

	CloseableHttpClient http;
	PoolingHttpClientConnectionManager phcm;
	
	public CloseHttpConnectionsOnLogout(CloseableHttpClient http,PoolingHttpClientConnectionManager phcm) {
		this.http = http;
		this.phcm = phcm;
	}
