...
public class Workflows implements java.io.Serializable {
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "workflows", cascade = CascadeType.PERSIST, orphanRemoval = true)
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "workflow", cascade = CascadeType.PERSIST, orphanRemoval = true)
